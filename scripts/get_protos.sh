...
#    Updated: 2019/10/22 02:38:29 by ldevelle         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
grep -A1 -e ft_ -e nalloc -e get_next_line -e gnl |
grep -A1 -e ^int -e ^char -e ^void -e ^size_t -e ^ssize_t -e ^t_list -e ^intmax_t -e ^uintmax_t -e ^t_tab -e ^float -e "\.\.\." |
