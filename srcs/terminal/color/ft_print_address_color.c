...
/*   Updated: 2019/05/01 19:19:40 by ldevelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_print_address_color(intmax_t nb)
{
	...
	if (!nb)
		...
		ft_putstr_color(ft_nb_to_a(nb, 16),
		ft_random(0, 255, nb, color),
		ft_random(0, 255, nb, color / 2),
		ft_random(0, 255, nb, color / 3));
	ft_putstr_color("|", 255, 255, 255);
}
